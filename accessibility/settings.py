"""
Django settings for accessibility project.
"""
...
DATATYPE_LOCATIONS.append('accessibility.datatypes')
...
SECRET_KEY = 'lkw#a%s3d)hjrsypj%c=za%$2@z6=^(4hwzyrx115g(bvf50!r'
...
ELASTICSEARCH_PREFIX = 'accessibility'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'accessibility.search_indexes.sample_index.SampleIndex',
...
SESSION_COOKIE_NAME = 'accessibility'
